...
export interface AdminInsights {
  ...
  overview: {
    activeSessions: InsightMetric;
    results: InsightMetric;
    paidVnd: InsightMetric;
    pointsSpent: InsightMetric;
    errors: InsightMetric;
  };
  daily: {
    day: string;
  ...
  modules: InsightFeature[];
  devices: { device: string; events: number }[];
  rewards: {
    repeatAttendance: number | null;
    milestones: number | null;
    attendanceDaily: { day: string; count: number }[];
    ...
    referredUsed: number | null;
    referredPaid: number | null;
    adStarted: number | null;
    adGranted: number | null;
