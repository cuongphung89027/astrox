...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Tương Hợp — Đối chiếu hai lá số", description: "Đối chiếu cung hoàng đạo của hai người, xem mức độ tương hợp về tính cách và cảm xúc.", images: ["/assets/og/trangchu.png"] },
};
