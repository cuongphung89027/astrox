...
const root=new URL('../../',import.meta.url),dir=new URL('.dev-admin/',root);mkdirSync(dir,{recursive:true,mode:0o700});
...
if(process.env.ASTROX_LOCAL_BACKEND!=='0'){
 native.exec(readFileSync(new URL('services/backend/test/legacy-schema.sql',root),'utf8'));
