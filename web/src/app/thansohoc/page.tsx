...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Thần Số Học — Giải mã con số cuộc đời", description: "Tính Số Chủ Đạo, Số Đường Đời và các chỉ số Thần Số Học, luận giải ý nghĩa bằng AstroX.", images: ["/assets/og/thansohoc.png"] },
};
